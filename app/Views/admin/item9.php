                    ...
                    <div class="card-body p-1">
                       ...
                       <div class="table-responsive mb-0 mt-0">
                            <table id="basic-datatables" class="display table table-bordered table-striped responsive" style="width:100%">
                                ...
                                <tbody>
                                        <?php foreach ($itemall as $key => $itemall_item) : ?>
										<div id="accordion<?= $key + 1; ?>">
                                            <tr>
                                                ...
                                                <td class="text-center">
													<a href="<?= base_url('/admin/createItemUp/'.$itemall_item['it_id'])?>" class="btn btn-success btn-sm waves-effect waves-light" ><i class="fa fa-search"></i></a>
													</div>
                                                </td>
                                            </tr>
										</div>
								...
								<div class="form-group">
									...
									<label class="input-group-btn">
                                            <span class="btn btn-primary btn-sm">
                                                เลือกไฟล์ <input type="file" style="display: none;" id="iu_fileup" name="iu_fileup" class="form-control">
                                            </span>
									</label>
								</div>
							</div>
